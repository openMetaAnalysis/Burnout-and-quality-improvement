...
1. Nutting PA, Crabtree BF, Miller WL, Stewart EE, Stange KC, Jaén CR. Journey to the patient-centered medical home: a qualitative analysis of the experiences of practices in the National Demonstration Project. Ann Fam Med. 2010;8 Suppl 1:S45-56; S92. doi: 10.1370/afm.1075. Erratum in: Ann Fam Med. 2010 Jul-Aug;8(4):369. PMID: [20530394](http://pubmed.gov/20530394) *Qualitative study that did not measure burnout but comment on 'local control of the developmental pathway'*
1. Boult C, Reider L, Frey K, Leff B, Boyd CM, Wolff JL, Wegener S, Marsteller J, Karm L, Scharfstein D. Early effects of "Guided Care" on the quality of health care for multimorbid older persons: a cluster-randomized controlled trial. J Gerontol A Biol Sci Med Sci. 2008 Mar;63(3):321-7. PMID: [18375882](http://pubmed.gov/18375882). "Studied provider satisfaction, but not burnout*
